...
\titulo{Um Módulo de Sensoriamento Voluntário aplicado a um Projeto de Ciência Cidadã}

\author{Felipe Rodolfo Santos Corrêa} %% coloque o nome do(s) autor(es)

\descriccao{Proposta de Dissertação de Mestrado do Curso de Pós-Graduação em Computação Aplicada Orientada pelo Dr. Fernando Manuel Ramos e Dr. Eduardo Fávero Pacheco da Luz}
